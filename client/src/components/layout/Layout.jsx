        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  <h3 className="text-xl font-bold">JiraniHub</h3>
                  <p className="text-gray-400 text-sm">Building stronger communities</p>
                </div>
              </div>
              <p className="text-gray-400 mb-4 max-w-md">
                JiraniHub connects neighbors and builds stronger communities through local marketplace, 
                events, and services. Join thousands of users creating meaningful connections.
              </p>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center">
            <p className="text-gray-400">
              © 2024 JiraniHub. All rights reserved. Built with ❤️ for stronger communities.
            </p>
          </div>
        </div>
      </footer>
